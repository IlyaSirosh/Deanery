...
public class EditClassView extends View{
    ...
    public void renderView(Map<String, Object> params) throws UnsatisfiedDependencyException {
        ...
        okButton.addActionListener(e -> {
            ...
            newClass.setClassId(Integer.parseInt(params.get("id").toString()));
            ...
            MainController.getMainController().renderTemplate("/updateClass", new HashMap<String, Object>() {{put("class", newClass);}});
        ...
        JLabel mainLabel = new JLabel("Edit class");
