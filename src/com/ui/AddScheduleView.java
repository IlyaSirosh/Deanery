...
@View
@RequestPath("/addSchedule")
public class AddScheduleView extends com.ui.View {
    ...
    public void renderView(Map<String, Object> params) throws UnsatisfiedDependencyException {
        ...
        okButton.addActionListener(e -> {
            ...
            MainController.getMainController().renderTemplate("/saveSchedule", new HashMap<String, Object>() {{put("schedule", newSchedule);}});
