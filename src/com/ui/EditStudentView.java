...
public class EditStudentView extends View{
    ...
    public void renderView(Map<String, Object> params) throws UnsatisfiedDependencyException {
        ...
        okButton.addActionListener(e -> {
            ...
            newStudent.setStudentId(Integer.parseInt(params.get("id").toString()));
            ...
            MainController.getMainController().renderTemplate("/updateStudent", new HashMap<String, Object>() {{put("student", newStudent);}});
        ...
        JLabel mainLabel = new JLabel("Edit student");
